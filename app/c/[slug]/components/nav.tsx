    ...
    >
      <div className="max-w-6xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between">
        ...
        <div className="hidden sm:flex items-center gap-3">
          ...
          <button
            onClick={onBookClick}
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-[13px] font-semibold transition-all hover:shadow-lg hover:shadow-blue-500/25 active:scale-95"
          >
      ...
      {menuOpen && (
        <div className="sm:hidden bg-white/95 backdrop-blur-xl border-t border-slate-100 px-5 py-4 space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-blue-600 text-white text-[14px] font-semibold"
          >
            <CalendarDays className="w-4 h-4" />
            Цаг авах
          </button>
