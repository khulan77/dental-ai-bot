    ...
    <>
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          {/* Main CTA card */}
          <div className="relative rounded-[2.5rem] bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 p-10 sm:p-16 overflow-hidden text-center shadow-2xl shadow-blue-600/30">
            ...
            <div className="relative flex flex-col sm:flex-row gap-3 justify-center">
              <button
                onClick={onBookClick}
                className="flex items-center justify-center gap-2.5 px-8 py-4 rounded-2xl bg-white text-blue-700 text-[15px] font-bold hover:bg-blue-50 transition-all hover:shadow-xl hover:-translate-y-0.5 active:scale-95"
              >
          ...
          {(clinic.address || phone) && (
            <div className="grid sm:grid-cols-2 gap-4 mt-8">
              {clinic.address && (
                ...
                >
                  <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center flex-shrink-0 group-hover:bg-blue-600 transition-colors">
                  ...
                  <div>
                    ...
                    <div className="text-[14px] font-semibold text-slate-800 leading-relaxed group-hover:text-blue-700 transition-colors">{clinic.address}</div>
              ...
              <div className="space-y-4">
                {phone && (
                  <a href={`tel:${phone}`} className="flex items-center gap-3 group">
                    <div className="w-8 h-8 rounded-lg bg-white/5 group-hover:bg-blue-600 flex items-center justify-center transition-colors flex-shrink-0">
                ...
                {clinic.address && (
                  ...
                  >
                    <div className="w-8 h-8 rounded-lg bg-white/5 group-hover:bg-blue-600 flex items-center justify-center transition-colors flex-shrink-0 mt-0.5">
                ...
                <button
                  onClick={onBookClick}
                  className="flex items-center gap-2 mt-2 px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-[13px] font-semibold transition-all hover:shadow-lg hover:shadow-blue-500/20 active:scale-95"
                >
